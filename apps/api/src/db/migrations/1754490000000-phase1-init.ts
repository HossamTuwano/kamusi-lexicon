/**
 * Phase 1 initial schema — TypeORM MigrationInterface.
 * Prefer `DB_MIGRATIONS_RUN=true` (and DB_SYNC=false) outside local throwaway DBs.
 */
import { MigrationInterface, QueryRunner } from 'typeorm';

export class Phase1Init1754490000000 implements MigrationInterface {
  name = 'Phase1Init1754490000000';
