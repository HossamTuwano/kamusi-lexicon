...
const lemma_report_entity_1 = require("./lemma-report.entity");
...
__decorate([
    (0, typeorm_1.Column)({ default: 0 }),
    __metadata("design:type", Number)
], Lemma.prototype, "report_count", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: false }),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => lemma_report_entity_1.LemmaReport, (r) => r.lemma),
    __metadata("design:type", Array)
], Lemma.prototype, "reports", void 0);
